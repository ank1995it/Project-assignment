...
var UserController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.UserService.register(body)];
                    case 1:
                        token = _a.sent();
    ...
    UserController.prototype.initialiseRoutes = function () {
        this.router.post(this.path + "/register", validation_middleware_1.default(user_validation_1.default.register), this.register);
        this.router.post(this.path + "/login", validation_middleware_1.default(user_validation_1.default.login), this.login);
