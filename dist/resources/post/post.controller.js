...
var post_validation_1 = __importDefault(require("@/resources/post/post.validation"));
...
var PostController = /** @class */ (function () {
    function PostController() {
        ...
        this.create = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var body, post, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        body = req.body;
                        return [4 /*yield*/, this.PostService.create(body)];
                    case 1:
                        post = _a.sent();
        ...
        this.getPost = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.PostService.getPost(req.query)];
                    case 1:
                        post = _a.sent();
    ...
    PostController.prototype.initialiseRoutes = function () {
        this.router.post("" + this.path, validation_middleware_1.default(post_validation_1.default.create), this.create);
